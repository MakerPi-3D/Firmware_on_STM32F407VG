                               ...
                               USB_OTG_CORE_ID_TypeDef coreID)
{
  ...
  pdev->cfg.speed            = USB_OTG_SPEED_FULL_OLD;
...
enum USB_OTG_SPEED USB_OTG_GetDeviceSpeed (USB_OTG_CORE_HANDLE *pdev)
{
  ...
  {
  case DSTS_ENUMSPD_HS_PHY_30MHZ_OR_60MHZ_OLD:
    speed = USB_SPEED_HIGH;
    break;
  case DSTS_ENUMSPD_FS_PHY_30MHZ_OR_60MHZ_OLD:
  case DSTS_ENUMSPD_FS_PHY_48MHZ_OLD:
    speed = USB_SPEED_FULL;
    break;
    
  case DSTS_ENUMSPD_LS_PHY_6MHZ_OLD:
    speed = USB_SPEED_LOW;
    break;
  }
