...
#define USB_OTG_SPEED_FULL_OLD      1
...
/** @defgroup __DEVICE_DEFINES_
  * @{
  */
#define DSTS_ENUMSPD_HS_PHY_30MHZ_OR_60MHZ_OLD     0
#define DSTS_ENUMSPD_FS_PHY_30MHZ_OR_60MHZ_OLD     1
#define DSTS_ENUMSPD_LS_PHY_6MHZ_OLD               2
#define DSTS_ENUMSPD_FS_PHY_48MHZ_OLD              3
