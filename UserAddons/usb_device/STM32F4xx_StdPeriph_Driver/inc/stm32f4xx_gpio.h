...
#define IS_GPIO_MODE_OLD(MODE) (((MODE) == GPIO_Mode_IN)  || ((MODE) == GPIO_Mode_OUT) || \
...
#define IS_GPIO_SPEED_OLD(SPEED) (((SPEED) == GPIO_Low_Speed) || ((SPEED) == GPIO_Medium_Speed) || \
...
#define IS_GPIO_PIN_OLD(PIN) ((((PIN) & (uint16_t)0x00) == 0x00) && ((PIN) != (uint16_t)0x00))
...
#if defined (STM32F40_41xxx)
#define IS_GPIO_AF_OLD(AF)   (((AF) == GPIO_AF_RTC_50Hz)  || ((AF) == GPIO_AF_TIM14)     || \
