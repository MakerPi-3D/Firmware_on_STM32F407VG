...
#define IS_RCC_HSE_OLD(HSE) (((HSE) == RCC_HSE_OFF) || ((HSE) == RCC_HSE_ON) || \
                         ((HSE) == RCC_HSE_Bypass))
/**
  * @}
  */ 
...
#define IS_RCC_HCLK_OLD(HCLK) (((HCLK) == RCC_SYSCLK_Div1) || ((HCLK) == RCC_SYSCLK_Div2) || \
...
#define IS_RCC_PCLK_OLD(PCLK) (((PCLK) == RCC_HCLK_Div1) || ((PCLK) == RCC_HCLK_Div2) || \
...
#define IS_RCC_LSE_OLD(LSE) (((LSE) == RCC_LSE_OFF) || ((LSE) == RCC_LSE_ON) || \
                         ((LSE) == RCC_LSE_Bypass))
/**
  * @}
  */ 
...
#define IS_RCC_RTCCLK_SOURCE_OLD(SOURCE) (((SOURCE) == RCC_RTCCLKSource_LSE) || \
...
#define IS_RCC_MCO1SOURCE_OLD(SOURCE) (((SOURCE) == RCC_MCO1Source_HSI) || ((SOURCE) == RCC_MCO1Source_LSE) || \
...
#define IS_RCC_MCO2SOURCE_OLD(SOURCE) (((SOURCE) == RCC_MCO2Source_SYSCLK) || ((SOURCE) == RCC_MCO2Source_PLLI2SCLK)|| \
