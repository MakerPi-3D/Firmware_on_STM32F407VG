...
void RCC_HSEConfig(uint8_t RCC_HSE)
{
  ...
  assert_param(IS_RCC_HSE_OLD(RCC_HSE));
...
/**
  ...
  *         HSE_STARTUP_TIMEOUT in stm32f4xx_OLD.h file. You can tailor it depending
...
{
  /* Check the parameters */
  assert_param(IS_RCC_LSE_OLD(RCC_LSE));
...
void RCC_MCO1Config(uint32_t RCC_MCO1Source, uint32_t RCC_MCO1Div)
{
  ...
  /* Check the parameters */
  assert_param(IS_RCC_MCO1SOURCE_OLD(RCC_MCO1Source));
...
void RCC_MCO2Config(uint32_t RCC_MCO2Source, uint32_t RCC_MCO2Div)
{
  ...
  /* Check the parameters */
  assert_param(IS_RCC_MCO2SOURCE_OLD(RCC_MCO2Source));
...
void RCC_HCLKConfig(uint32_t RCC_SYSCLK)
{
  ...
  /* Check the parameters */
  assert_param(IS_RCC_HCLK_OLD(RCC_SYSCLK));
...
void RCC_PCLK1Config(uint32_t RCC_HCLK)
{
  ...
  /* Check the parameters */
  assert_param(IS_RCC_PCLK_OLD(RCC_HCLK));
...
/**
  ...
  * @note     (*) HSI_VALUE is a constant defined in stm32f4xx_OLD.h file (default value
  *               16 MHz) but the real value may vary depending on the variations
  *               in voltage and temperature.
  * @note     (**) HSE_VALUE is a constant defined in stm32f4xx_OLD.h file (default value
...
void RCC_RTCCLKConfig(uint32_t RCC_RTCCLKSource)
{
  ...
  /* Check the parameters */
  assert_param(IS_RCC_RTCCLK_SOURCE_OLD(RCC_RTCCLKSource));
