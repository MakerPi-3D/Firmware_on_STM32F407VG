...
void USB_OTG_BSP_Init(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  GPIO_InitTypeDef_OLD GPIO_InitStructure;    
#endif
...
//  NVIC_InitTypeDef NVIC_InitStructure; 
  ...
  RCC_AHB1PeriphClockCmd( RCC_AHB1Periph_GPIOA | RCC_AHB1Periph_GPIOB | RCC_AHB1Periph_GPIOH |
                         RCC_AHB1Periph_GPIOC |RCC_AHB1Periph_GPIOI, ENABLE);    
