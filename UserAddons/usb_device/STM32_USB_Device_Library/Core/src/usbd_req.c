...
__ALIGN_BEGIN_OLD uint32_t USBD_ep_status __ALIGN_END  = 0; 
  ...
  #endif
#endif /* USB_OTG_HS_INTERNAL_DMA_ENABLED */
__ALIGN_BEGIN_OLD uint32_t  USBD_default_cfg __ALIGN_END  = 0;
  ...
  #endif
#endif /* USB_OTG_HS_INTERNAL_DMA_ENABLED */
__ALIGN_BEGIN_OLD uint32_t  USBD_cfg_status __ALIGN_END  = 0;  
  ...
  #endif
#endif /* USB_OTG_HS_INTERNAL_DMA_ENABLED */
__ALIGN_BEGIN_OLD uint8_t USBD_StrDesc[USB_MAX_STR_DESC_SIZ] __ALIGN_END ;
/**
  * @}
  */ 
                               ...
                               USB_SETUP_REQ *req)
{
  ...
  case USB_DESC_TYPE_CONFIGURATION:
    ...
    if((pdev->cfg.speed == USB_OTG_SPEED_FULL_OLD )&&
