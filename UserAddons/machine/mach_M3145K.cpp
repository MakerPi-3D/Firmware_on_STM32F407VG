...
namespace sg_machine
{
  ...
  static void machine_M3145K_init_grbl()
  {
    float buf4[] = DEFAULT_AXIS_STEPS_PER_UNIT_M3145K;
    float buf5[] = DEFAULT_MAX_FEEDRATE_M3145K;
    long buf6[] = DEFAULT_MAX_ACCELERATION_M3145K;
